...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-12-13T08:41').blur().should('have.value', '2022-12-13T08:41');

      cy.get(`[data-cy="endDate"]`).type('2022-12-12T15:39').blur().should('have.value', '2022-12-12T15:39');
