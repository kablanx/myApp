  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="myApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="$t('myApp.jobHistory.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.jobHistory.startDate')" for="job-history-startDate">Start Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.jobHistory.endDate')" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.jobHistory.language')" for="job-history-language">Language</label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                v-bind:label="$t('myApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.jobHistory.department')" for="job-history-department">Department</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.jobHistory.employee')" for="job-history-employee">Employee</label>
